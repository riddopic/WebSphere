...
default[:websphere][:ihs] = {
  # Specify whether or not to install IBM HTTP Server (IHS).
  install: true,
  ...
  repositories: ->{
    'http://repo.mudbox.dev/ibm/repositorymanager/com.ibm.websphere.IHS.v85' },
  ...
  install_location: '/opt/IBM/HTTPServer',
  ...
  data: [
    ...
    { key:   'eclipseLocation',
      value: lambda { node[:websphere][:ihs][:install_location] } },
    ...
    { key:   'user.ihs.createAdminUserGroup',     value: false    }, #######
